...
exports.gisRepository = exports.seedLayers = void 0;
...
exports.gisRepository = {
    layers: (0, repository_1.collection)("gis_layers"),
    markers: (0, repository_1.collection)("gis_markers"),
    reset() {
        this.layers.seed(exports.seedLayers);
        this.markers.seed(seedMarkers);
    },
};
exports.default = exports.gisRepository;
