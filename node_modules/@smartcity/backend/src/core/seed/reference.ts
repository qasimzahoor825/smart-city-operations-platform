...
export const seedSlaRules: SeedSlaRule[] = [
...
export interface SeedComplaintCategory {
  id: string;
  name: string;
  code: string;
  description: string;
...
export const seedComplaintCategories: SeedComplaintCategory[] = [
...
export interface SeedTrafficZone {
  id: string;
  name: string;
  congestion: string;
  latitude: number;
...
export const seedTrafficZones: SeedTrafficZone[] = [
