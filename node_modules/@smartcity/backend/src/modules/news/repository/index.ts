...
const seedNews: StoredNewsArticle[] = [
  {
    id: "nws_seed_001",
    ...
    content:
      "The city unveiled a new multi-purpose pavilion in Central Park today. Built with sustainable materials, the pavilion hosts farmers markets and community events year-round.",
    category: "GENERAL",
...
export const newsRepository = {
  articles: collection<StoredNewsArticle>("news_articles"),

  findBySlug(slug: string): StoredNewsArticle | undefined {
